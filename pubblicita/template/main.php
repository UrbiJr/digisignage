	  	...
	  	<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
		  	<div class="container-fluid">
		        <ul class="navbar-nav">
			        ...
			        <li class="nav-item">
			          	<a class="nav-link" href="index.php?model=sequenza&action=start">Ordina</a>
			        </li>
			        <li class="nav-item">
				...
				<a href="index.php?model=login&action=logout"><span class="glyphicon glyphicon-user"></span>Logout</a>
		  	</div>
		</nav>
